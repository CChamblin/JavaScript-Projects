...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("images/x4.png")';
...
//drawWinLin functino is called to draw line if condition is met.
function checkWinConditions() {
    ...
    // O 0, 1, 2 condition.
    else if (arrayIncludes('0O', '1O', '2O')) {drawWinLine(50, 100, 5558, 100) }
    // O 3, 4, 5 condition.
